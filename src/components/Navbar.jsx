        ...
        <nav className="fixed top-0 left-0 w-full h-20 md:h-24 bg-black z-50 border-b border-black px-4 md:px-8 flex items-center justify-between gap-6 font-oswald text-xs tracking-wider">
            ...
            <div className="flex items-center gap-10 ml-auto">
                <div className="flex items-center gap-8 text-white">
                    ...
                    <a href="/schedule" className="font-bold hover:text-orange-600 transition-colors">SCHEDULE</a>
                    <Link to="/about" className="font-bold hover:text-orange-600 transition-colors">ABOUT</Link>
                </div>

                <div className="flex items-center gap-6 text-white/80">
                    <a href="https://www.youtube.com/channel/UCzycs8MqvIY4nXWwS-v4J9g" className="hover:text-white transition-opacity"><YoutubeIcon /></a>
                    <a href="https://twitter.com/ONEOKROCK_japan" className="hover:text-white transition-opacity"><TwitterIcon /></a>
                    <a href="https://www.instagram.com/oneokrockofficial/" className="hover:text-white transition-opacity"><InstagramIcon /></a>
                </div>
            </div>
        </nav>
    );
