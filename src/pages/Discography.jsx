      ...
      <main className="flex-grow">
        ...
        <section className="relative pt-32 pb-24 overflow-hidden border-b border-zinc-900">
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-8">
            {/* ✨ Updated: text-2xl md:text-3xl to perfectly match Album Detail */}
            <h2 className="font-oswald text-2xl md:text-3xl font-extrabold text-white mb-8 tracking-wide uppercase">LATEST RELEASE</h2>

            <div className="flex flex-col md:flex-row gap-10 lg:gap-16 items-start">
              
              <div className="w-full max-w-md shrink-0 relative group cursor-pointer">
                <Link to="/album/detox" className="block shadow-[0_0_40px_rgba(0,0,0,0.8)] border border-zinc-800 overflow-hidden relative">
                  <img src={latestCover} alt="DETOX Album Cover" className="w-full h-auto object-cover transition-transform duration-500 group-hover:scale-105" />
              ...
              <div className="w-full flex-grow mt-4 md:mt-0">
                ...
                <Link to="/album/detox" className="md:hidden block text-center px-8 py-3 bg-zinc-900 border border-zinc-800 hover:bg-orange-600 text-white font-bold tracking-widest uppercase transition-colors">
                  Go to Album Page
                </Link>
